...
import type { PlatformLayerData } from "@/lib/queries";

export default function PlatformFramework({ layers: LAYERS }: { layers: PlatformLayerData[] }) {
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="flex items-start gap-4 mb-6">
                  <div className="w-14 h-14 rounded-2xl flex items-center justify-center shrink-0" style={{ background: `${layer.color_hex}25` }}>
                    {(() => {
                      const LayerIcon = getIcon(layer.icon);
                      return <LayerIcon className="w-7 h-7" style={{ color: layer.color_hex }} />;
                    })()}
                  </div>
                  <div>
                    <div className="text-xs font-bold uppercase tracking-widest mb-1" style={{ color: layer.color_hex }}>
